$(function() {
	...
	*/
    ...
    var varCLN = getURLParameter('cln');
    var	varCLNP = "cln=" + varCLN;
    var varPID = getURLParameter('pid');
    var	varPIDP = "pid=" + varPID;
    var varCID = getURLParameter('cid');
    var	varCIDP = "cid=" + varCID;
    var varPN = getURLParameter('pn');
    var	varPNP = "pn=" + varPN;
    ...
    if (/iPad|iPhone|iPod/.test(navigator.platform)) {
        ...
        $("#cover").fadeOut(200);
        if (varTF !="" && varTF !=null){
            var iOS = "https://wellhealth.typeform.com/to/" + varTF + "?" + varCFNP + "&" + varCLNP + "&" + varPIDP + "&" + varCIDP + "&" + varPNP + "&" + varFAIDP + "&os=1";        
        ...
        //$("#cover").fadeOut(200);
        if (varTF !="" && varTF !=null){
            location.href = "https://wellhealth.typeform.com/to/" + varTF + "?" + varCFNP + "&" + varCLNP + "&" + varPIDP + "&" + varCIDP + "&" + varPNP + "&" + varFAIDP + "&os=2";
        }else{
